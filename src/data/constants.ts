// --- POZ KÜTÜPHANESİ ---
export const INITIAL_POS_LIBRARY = {
...
// --- BAŞLANGIÇ LOKASYONLARI (MAHALLER) ---
    ...
    children: [
      {
        ...
        type: 'floor',
        children: [
          { id: 3, name: 'Giriş Holü', type: 'room' },
          { id: 4, name: 'Salon', type: 'room' }
        ]
      }
    ]
  }
...
// --- STATİK METRAJ BAŞLANGIÇ VERİSİ ---
export const initialStaticData = [
...
// --- MİMARİ METRAJ BAŞLANGIÇ VERİSİ ---
export const initialArchitecturalData = [
