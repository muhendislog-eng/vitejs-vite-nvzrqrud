  ...
  return (
    <div className="w-full max-w-full space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end border-b border-slate-200 pb-4 gap-4 w-full">
         ...
         <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <button 
                ...
                className="flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 font-bold transition-all shadow-md active:scale-95 whitespace-nowrap ml-auto md:ml-0"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
          {/* PVC ÖZET */}
          <div className="bg-blue-50 p-5 rounded-2xl border border-blue-200 shadow-sm flex flex-col justify-between h-full">
          ...
          {/* ALÜMİNYUM ÖZET */}
          <div className="bg-slate-50 p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between h-full">
            <div className="flex justify-between items-start mb-2">
