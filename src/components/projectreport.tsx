...
const ProjectReport: React.FC<ProjectReportProps> = ({ staticItems, architecturalItems, projectInfo }) => {
  ...
  const { 
    ...
    // 2. Tahmini Diğer Giderler (%20 Kuralı)
    ...
    [...staticItems, ...architecturalItems].forEach(item => {
    ...
    // En yüksek maliyetli 5 kategoriyi al, gerisini 'Diğer' yap
    ...
    <div className="w-full max-w-full space-y-8 animate-in fade-in duration-500 project-report-container">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
         ...
         <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm h-[300px] flex flex-col">
                <h4 className="text-slate-700 font-bold text-sm mb-4">Maliyet Yoğunluğu</h4>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <div className="text-sm text-yellow-800">
              ...
              <p>Bu rapor, <strong>2025 yılı Çevre, Şehircilik ve İklim Değişikliği Bakanlığı</strong> birim fiyatları baz alınarak oluşturulmuştur. Elektrik ve Mekanik tesisat giderleri, inşaat sektöründeki genel kabullere dayanarak toplam maliyetin %20'si olarak (her biri %10) tahmin edilmiştir. Kesin bütçe için ilgili disiplinlerin detaylı projeleri gereklidir.</p>
          </div>
      </div>
