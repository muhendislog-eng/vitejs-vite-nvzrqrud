...
const INITIAL_POS_LIBRARY = {
  'Betonarme ve Kalıp İşleri': [
    {
      pos: '15.150.1003',
      desc: 'C 16/20 basınç dayanım sınıfında hazır beton dökülmesi',
      unit: 'm³',
      price: 3150.44,
    },
    {
      pos: '15.150.1004',
      desc: 'C 20/25 basınç dayanım sınıfında hazır beton dökülmesi',
      unit: 'm³',
      price: 3250.6,
    },
    {
      pos: '15.150.1005',
      desc: 'C 25/30 basınç dayanım sınıfında hazır beton dökülmesi',
      unit: 'm³',
      price: 3380.9,
    },
    {
      pos: '15.150.1006',
      desc: 'C 30/37 basınç dayanım sınıfında hazır beton dökülmesi',
      unit: 'm³',
      price: 3553.73,
    },
    {
      pos: '15.150.1007',
      desc: 'C 35/45 basınç dayanım sınıfında hazır beton dökülmesi',
      unit: 'm³',
      price: 3750.25,
    },
    {
      pos: '15.150.1008',
      desc: 'C 40/50 basınç dayanım sınıfında hazır beton dökülmesi',
      unit: 'm³',
      price: 3950.8,
    },
    {
      pos: '15.160.1003',
      desc: 'Ø 8- Ø 12 mm nervürlü beton çelik çubuğu, çubukların kesilmesi, bükülmesi ve yerine konulması',
      unit: 'Ton',
      price: 45954.91,
    },
    {
      pos: '15.160.1004',
      desc: 'Ø 14- Ø 28 mm nervürlü beton çelik çubuğu, çubukların kesilmesi, bükülmesi ve yerine konulması',
      unit: 'Ton',
      price: 44180.65,
    },
    {
      pos: '15.160.1005',
      desc: 'Ø 32- Ø 50 mm nervürlü beton çelik çubuğu, çubukların kesilmesi, bükülmesi ve yerine konulması',
      unit: 'Ton',
      price: 43500.5,
    },
    {
      pos: '15.160.1010',
      desc: 'Çelik hasırın yerine konulması (Her çeşit)',
      unit: 'Ton',
      price: 52100.2,
    },
    {
      pos: '15.180.1003',
      desc: 'Plywood ile düz yüzeyli betonarme kalıbı yapılması',
      unit: 'm²',
      price: 1011.06,
    },
    {
      pos: '15.180.1001',
      desc: 'Ahşap kalıp yapılması (Rendelemiş kereste ile)',
      unit: 'm²',
      price: 950.4,
    },
    {
      pos: '15.185.1005',
      desc: 'Çelik borudan kalıp iskelesi yapılması (0-4m)',
      unit: 'm³',
      price: 124.89,
    },
  ],
  'Duvar ve Kaba Yapı': [
    {
      pos: '15.220.1011',
      desc: '85 mm kalınlığında yatay delikli tuğla (190 x 85 x 190 mm) ile duvar yapılması',
      unit: 'm²',
      price: 598.79,
    },
    {
      pos: '15.220.1012',
      desc: '100 mm kalınlığında yatay delikli tuğla (200 x 100 x 200 mm) ile duvar yapılması',
      unit: 'm²',
      price: 741.66,
    },
    {
      pos: '15.220.1013',
      desc: '135 mm kalınlığında düşey delikli tuğla ile duvar yapılması',
      unit: 'm²',
      price: 765.4,
    },
    {
      pos: '15.220.1014',
      desc: '135 mm kalınlığında yatay delikli tuğla (190 x 135 x 190 mm) ile duvar yapılması',
      unit: 'm²',
      price: 794.93,
    },
    {
      pos: '15.220.1015',
      desc: '190 mm kalınlığında yatay delikli tuğla (190 x 190 x 135 mm) ile duvar yapılması',
      unit: 'm²',
      price: 907.18,
    },
    {
      pos: '10.200.1001',
      desc: 'Gazbeton duvar bloğu (G2 sınıfı) ile duvar yapılması',
      unit: 'm³',
      price: 2850.5,
    },
  ],
  'İnce İşler (Sıva, Şap, Boya)': [
    {
      pos: '15.275.1111',
      desc: '250/350 kg çimento dozlu kaba ve ince harçla sıva yapılması (dış cephe)',
      unit: 'm²',
      price: 601.88,
    },
    {
      pos: '15.275.1112',
      desc: '200/250 kg kireç/çimento karışımı kaba ve ince harçla sıva yapılması (iç cephe)',
      unit: 'm²',
      price: 535.6,
    },
    {
      pos: '15.280.1009',
      desc: 'Perlitli sıva alçısı ve saten alçı ile kaplama yapılması',
      unit: 'm²',
      price: 682.9,
    },
    {
      pos: '15.280.1011',
      desc: 'Saten alçı kaplaması yapılması (ortalama 1 mm)',
      unit: 'm²',
      price: 250.0,
    },
    {
      pos: '15.540.1520',
      desc: 'Yeni sıva yüzeylere astar uygulanarak iki kat Su bazlı Silikonlu Mat İç Cephe Boyası',
      unit: 'm²',
      price: 212.05,
    },
    {
      pos: '15.540.1502',
      desc: 'Eski boyalı yüzeylere astar uygulanarak Su bazlı Plastik Boya yapılması',
      unit: 'm²',
      price: 185.3,
    },
    {
      pos: '15.250.1111',
      desc: '2.5 cm kalınlığında 400 kg dozlu şap',
      unit: 'm²',
      price: 443.59,
    },
  ],
  'Çatı İşleri': [
    {
      pos: '15.300.1002',
      desc: 'Ahşaptan oturtma çatı yapılması (çatı örtüsünün altı OSB/3 kaplamalı)',
      unit: 'm²',
      price: 1544.23,
    },
    {
      pos: '15.305.1001',
      desc: 'Üst ve alt kiremit (alaturka) ile çatı örtüsü yapılması (3 Latalı)',
      unit: 'm²',
      price: 1560.74,
    },
    {
      pos: '15.305.1006',
      desc: 'Mahya kiremitleri ile mahya yapılması',
      unit: 'm',
      price: 516.11,
    },
    {
      pos: '15.310.1201',
      desc: '14 no.lu çinko levhadan eğimli çatı deresi yapılması',
      unit: 'm',
      price: 1226.74,
    },
    {
      pos: '15.310.1205',
      desc: '12 No.lu çinko levhadan sıva eteği, baca kenarı vb. yapılması',
      unit: 'm',
      price: 987.76,
    },
    {
      pos: '15.330.1004',
      desc: 'Çatı örtüsü altına polimer bitümlü örtü ile su yalıtımı yapılması',
      unit: 'm²',
      price: 353.95,
    },
  ],
  'Cephe İşleri': [
    {
      pos: '15.185.1013',
      desc: 'Ön yapımlı tam güvenlikli dış cephe iş iskelesi yapılması (0-51,50m)',
      unit: 'm²',
      price: 217.18,
    },
    {
      pos: '15.185.1014',
      desc: 'Ön yapımlı tam güvenlikli tavan iş iskelesi (0-21,50m)',
      unit: 'm³',
      price: 176.29,
      quantity: 0,
    },
    ...
    {
      pos: '15.341.1006',
      desc: '5 cm kalınlıkta Taşyünü levhalar ile dış cephe mantolama yapılması',
      unit: 'm²',
      price: 980.5,
    },
    {
      pos: '15.540.1602',
      desc: 'Saf akrilik esaslı Dış Cephe Boyası yapılması',
      unit: 'm²',
      price: 378.53,
    },
    {
      pos: '77.105.1001',
      desc: 'Mineral dolgulu kompozit alüminyum levhalar ile cephe kaplaması',
      unit: 'm²',
      price: 3995.34,
    },
  ],
  'Zemin ve Duvar Kaplamaları': [
    {
      pos: '15.385.1008',
      desc: '60x60 cm anma ebatlarında, I.kalite, beyaz, sırlı porselen karo döşeme kaplaması',
      unit: 'm²',
      price: 850.53,
    },
    {
      pos: '15.385.1009',
      desc: '60x60 cm anma ebatlarında, I.kalite, RENKLİ, sırlı porselen karo döşeme kaplaması',
      unit: 'm²',
      price: 920.45,
    },
    {
      pos: '15.385.1024',
      desc: '30x30 cm veya 33x33 cm anma ebatlarında, renkli, sırlı porselen karo kaplaması',
      unit: 'm²',
      price: 780.2,
    },
    {
      pos: '15.380.1056',
      desc: '30x60 cm anma ebatlarında, I.kalite, renkli seramik duvar karoları ile duvar kaplaması',
      unit: 'm²',
      price: 695.15,
    },
    {
      pos: '15.490.1003',
      desc: 'Laminat parke döşeme kaplaması yapılması (AC4 Sınıf 32)',
      unit: 'm²',
      price: 685.88,
    },
    {
      pos: '15.490.1004',
      desc: 'Laminat parke döşeme kaplaması yapılması (AC5 Sınıf 33 - Yoğun Trafik)',
      unit: 'm²',
      price: 810.12,
    },
    {
      pos: '15.410.1413',
      desc: '3 cm kalınlığında renkli mermer levha ile dış denizlik yapılması',
      unit: 'm²',
      price: 3604.93,
    },
  ],
  'Kapı ve Pencere Doğramaları': [
    {
      pos: '15.455.1001',
      desc: 'PVC doğrama imalatı',
      unit: 'kg',
      price: 247.96,
    },
    {
      pos: '77.170.1009',
      desc: '120 Dk Dayanımlı Panik Barlı Yangın Kapısı (Tek Kanat)',
      unit: 'Adet',
      price: 21770.84,
    },
    {
      pos: '35.800.6105',
      desc: 'Yana kayan kapı motoru (300kg, 24V DC, 200W)',
      unit: 'Adet',
      price: 10793.75,
    },
    {
      pos: '35.800.6120',
      desc: 'Yana kayan kapı motoru (600kg, 24V DC, 350W)',
      unit: 'Adet',
      price: 14815.63,
    },
    {
      pos: '15.465.1101',
      desc: 'Pencere kolu (İspanyolet) takılması',
      unit: 'Adet',
      price: 145.5,
    },
    {
      pos: '15.465.1116',
      desc: 'Pencere menteşesi takılması',
      unit: 'Adet',
      price: 35.4,
    },
    {
      pos: '15.460.1010',
      desc: 'Isı yalıtımlı alüminyum doğrama imalatı',
      unit: 'kg',
      price: 350.0,
    },
    {
      pos: '15.470.1010',
      desc: '4+12+4 mm çift camlı pencere ünitesi',
      unit: 'm²',
      price: 1692.55,
    },
  ],
  'Hafriyat ve Zemin İşleri': [
    {
      pos: '15.120.1101',
      desc: 'Makine ile her derinlik ve her genişlikte yumuşak ve sert toprak kazılması (Derin kazı)',
      unit: 'm³',
      price: 65.95,
    },
    {
      pos: '15.120.1104',
      desc: 'Makine ile serbest kazı yapılması',
      unit: 'm³',
      price: 58.4,
    },
    {
      pos: '15.125.1010',
      desc: "63mm'ye kadar kırmataş serilmesi",
      unit: 'm³',
      price: 564.94,
    },
    {
      pos: '15.204.1001',
      desc: 'Ø 100 mm PVC drenaj borusu',
      unit: 'm',
      price: 55.29,
    },
  ],
...
const initialStaticData = [
  {
    id: 1,
    category: 'Hafriyat ve Zemin İşleri',
    pos: '15.120.1101',
    desc: 'Makine ile her derinlik ve her genişlikte yumuşak ve sert toprak kazılması (Derin kazı)',
    unit: 'm³',
    price: 65.95,
  ...
  },
  {
    ...
    category: 'Hafriyat ve Zemin İşleri',
    pos: '15.125.1010',
    desc: "63mm'ye kadar kırmataş temin edilerek, makine ile serme, sulama ve sıkıştırma yapılması",
    unit: 'm³',
    price: 564.94,
    quantity: 0,
  },
  {
    ...
    category: 'Hafriyat ve Zemin İşleri',
    pos: '15.204.1001',
    desc: 'Ø 100 mm anma çaplı, PVC esaslı koruge drenaj borusunun temini ve yerine döşenmesi',
    unit: 'm',
    price: 55.29,
    quantity: 0,
  },
  {
    id: 3,
    category: 'Betonarme ve Kalıp İşleri',
    pos: '15.150.1003',
    desc: 'C 16/20 basınç dayanım sınıfında, gri renkte, normal hazır beton dökülmesi',
    unit: 'm³',
    price: 3150.44,
    quantity: 0,
  },
  {
    ...
    category: 'Betonarme ve Kalıp İşleri',
    pos: '15.150.1006',
    desc: 'C 30/37 basınç dayanım sınıfında, gri renkte, normal hazır beton dökülmesi',
    unit: 'm³',
    price: 3553.73,
    quantity: 0,
  },
  {
    ...
    category: 'Betonarme ve Kalıp İşleri',
    pos: '15.160.1003',
    desc: 'Ø 8- Ø 12 mm nervürlü beton çelik çubuğu, kesilmesi, bükülmesi ve yerine konulması',
    unit: 'Ton',
    price: 45954.91,
    quantity: 0,
  },
  {
    ...
    category: 'Betonarme ve Kalıp İşleri',
    pos: '15.160.1004',
    desc: 'Ø 14- Ø 28 mm nervürlü beton çelik çubuğu, kesilmesi, bükülmesi ve yerine konulması',
    unit: 'Ton',
    price: 44180.65,
    quantity: 0,
  },
  ...
  {
    id: 10,
    category: 'Temel Yalıtım İşleri',
    pos: '15.255.1008',
    desc: 'Polimer bitümlü örtüler ile iki kat su yalıtımı yapılması',
    unit: 'm²',
    price: 618.3,
    quantity: 0,
  },
  {
    ...
    category: 'Temel Yalıtım İşleri',
    pos: '15.270.1008',
    desc: 'Çimento esaslı polimer modifiyeli yalıtım harcı ile su yalıtımı yapılması',
    unit: 'm²',
    price: 610.66,
    quantity: 0,
  },
...
const initialArchitecturalData = [
  {
    id: 3,
    category: 'Duvar ve Kaba Yapı',
    pos: '15.220.1012',
    desc: '100 mm yatay delikli tuğla duvar yapılması',
    unit: 'm²',
    price: 741.66,
    quantity: 0,
  },
  {
    ...
    category: 'Duvar ve Kaba Yapı',
    pos: '15.220.1014',
    desc: '135 mm yatay delikli tuğla duvar yapılması',
    unit: 'm²',
    price: 794.93,
    quantity: 0,
  },
  {
    ...
    category: 'Duvar ve Kaba Yapı',
    pos: '15.220.1015',
    desc: '190 mm yatay delikli tuğla duvar yapılması',
    unit: 'm²',
    price: 907.18,
    quantity: 0,
  },
  {
    ...
    pos: '15.300.1002',
    desc: 'Ahşaptan oturtma çatı (OSB/3 kaplamalı)',
    unit: 'm²',
    price: 1544.23,
    quantity: 0,
  },
  {
    ...
    category: 'Çatı İşleri',
    pos: '15.305.1001',
    desc: 'Alaturka kiremit çatı örtüsü (3 Latalı)',
    unit: 'm²',
    price: 1560.74,
    quantity: 0,
  },
  {
    ...
    category: 'Çatı İşleri',
    pos: '15.310.1201',
    desc: '14 no.lu çinko levhadan eğimli çatı deresi',
    unit: 'm',
    price: 1226.74,
    quantity: 0,
  },
  {
    ...
    category: 'Çatı İşleri',
    pos: '15.315.1002',
    desc: 'Ø 100 mm PVC yağmur borusu',
    unit: 'm',
    price: 260.23,
    quantity: 0,
  },
  {
    id: 17,
    category: 'Kapı ve Pencere Doğramaları',
    pos: '15.455.1001',
    desc: 'PVC doğrama imalatı',
    unit: 'kg',
    price: 247.96,
  ...
  },
  {
    ...
    category: 'Kapı ve Pencere Doğramaları',
    pos: '15.470.1010',
    desc: '4+4 mm çift camlı pencere ünitesi',
    unit: 'm²',
    price: 1692.55,
    quantity: 0,
  },
  {
    ...
    category: 'Kapı ve Pencere Doğramaları',
    pos: '15.510.1103',
    desc: 'Laminat kaplamalı, kraft dolgulu iç kapı kanadı',
    unit: 'm²',
    price: 3165.6,
    quantity: 0,
  },
  {
    ...
    category: 'Kapı ve Pencere Doğramaları',
    pos: '15.510.1001',
    desc: 'Ahşaptan masif tablalı iç kapı kasa ve pervazı',
    unit: 'm²',
    price: 2332.99,
    quantity: 0,
  },
  {
    ...
    category: 'Kapı ve Pencere Doğramaları',
    pos: '15.465.1002',
    desc: 'Gömme iç kapı kilidinin yerine takılması (Dar Tip)',
    unit: 'Adet',
    price: 126.25,
    quantity: 0,
  },
  {
    ...
    category: 'Kapı ve Pencere Doğramaları',
    pos: '15.465.1008',
    desc: 'Kapı kolu ve aynalarının yerine takılması (Kromajlı)',
    unit: 'Adet',
    price: 126.25,
    quantity: 0,
  },
  {
    ...
    category: 'Kapı ve Pencere Doğramaları',
    pos: '15.465.1010',
    desc: 'Menteşenin yerine takılması',
    unit: 'Adet',
    price: 22.28,
    quantity: 0,
  },
  {
    ...
    category: 'Kapı ve Pencere Doğramaları',
    pos: '77.170.1009',
    desc: '120 Dk Dayanımlı Panik Barlı Yangın Kapısı',
    unit: 'Adet',
    price: 21770.84,
    quantity: 0,
  },
  {
    id: 6,
    category: 'İnce İşler (Sıva, Şap, Boya)',
    pos: '15.250.1111',
    desc: '2.5 cm kalınlığında 400 kg dozlu şap',
    unit: 'm²',
    price: 443.59,
  ...
  },
  {
    ...
    category: 'İnce İşler (Sıva, Şap, Boya)',
    pos: '15.275.1116',
    desc: '250 kg çimento dozlu kaba sıva',
    unit: 'm²',
    price: 437.11,
    quantity: 0,
  },
  {
    ...
    category: 'İnce İşler (Sıva, Şap, Boya)',
    pos: '15.280.1009',
    desc: 'Perlitli sıva ve saten alçı kaplama',
    unit: 'm²',
    price: 682.9,
    quantity: 0,
  },
  {
    ...
    category: 'İnce İşler (Sıva, Şap, Boya)',
    pos: '15.280.1012',
    desc: 'Makina alçısı ile tavanlara tek kat alçı sıva',
    unit: 'm²',
    price: 459.11,
    quantity: 0,
  },
  {
    ...
    category: 'İnce İşler (Sıva, Şap, Boya)',
    pos: '15.540.1520',
    desc: 'Su bazlı Silikonlu Mat İç Cephe Boyası',
    unit: 'm²',
    price: 212.05,
    quantity: 0,
  },
  {
    id: 15,
    category: 'Zemin ve Duvar Kaplamaları',
    pos: '15.385.1008',
    desc: '60x60 cm anma ebatlarında, I.kalite, beyaz, sırlı porselen karo döşeme kaplaması',
    unit: 'm²',
    price: 850.53,
  ...
  },
  {
    ...
    category: 'Zemin ve Duvar Kaplamaları',
    pos: 'OZL.60X120',
    desc: '60x120 Parlak Granit Seramik',
    unit: 'm²',
    price: 1503.43,
    quantity: 0,
  },
  {
    ...
    category: 'Zemin ve Duvar Kaplamaları',
    pos: '15.490.1003',
    desc: 'Laminat parke döşeme kaplaması (AC4)',
    unit: 'm²',
    price: 685.88,
    quantity: 0,
  },
  {
    ...
    category: 'Zemin ve Duvar Kaplamaları',
    pos: '15.410.1413',
    desc: '3 cm renkli mermer denizlik',
    unit: 'm²',
    price: 3604.93,
    quantity: 0,
  },
  ...
  },
  {
    ...
    category: 'Cephe İşleri',
    pos: '77.105.1001',
    desc: 'Kompozit alüminyum levha cephe kaplaması',
    unit: 'm²',
    price: 3995.34,
    quantity: 0,
  },
        ...
        <div className="px-6 py-5 bg-slate-50 border-b border-slate-200 flex justify-between items-center">
          <div>
            <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2">
              ...
              {isAddingNew
                ? `Yeni Poz Ekle: ${category}`
                : 'Poz Değiştir / Ekle'}
            </h3>
            <p className="text-sm text-slate-500 mt-1">
              {searchTerm
                ? 'Tüm Kütüphanede Aranıyor'
                : 'Kategoriye Uygun Pozlar Listeleniyor'}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-5 border-b border-slate-100 bg-white">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none text-slate-700 placeholder-slate-400 shadow-inner transition-all"
              value={searchTerm}
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setManualPose({ ...manualPose, pos: e.target.value })
                    }
                    className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none transition-all font-mono"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setManualPose({ ...manualPose, desc: e.target.value })
                    }
                    className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none transition-all"
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setManualPose({ ...manualPose, unit: e.target.value })
                      }
                      className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none transition-all"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setManualPose({ ...manualPose, price: e.target.value })
                      }
                      className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-orange-500 outline-none transition-all"
                      placeholder="0.00"
                    />
              ...
              {displayPoses.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center h-64 text-slate-400">
                  ...
                  <p className="text-center mb-6 font-medium">
                    "{searchTerm}" aramasına uygun poz bulunamadı.
                    <br />
                    <span className="text-sm font-normal opacity-70">
                      Sistemde yüklü olmayan bir poz olabilir.
                    </span>
                  </p>
                  <button
...
const DoorCalculationArea = ({ items, setItems, onUpdateQuantities }) => {
  ...
  const totalDoorCount = items.reduce(
    (sum, item) => sum + (parseFloat(item.count) || 0),
    0
  );
  const totalLeafArea = items.reduce(
    (sum, item) => sum + calculateRowValues(item).leafArea,
    0
  );
  const totalFrameArea = items.reduce(
    (sum, item) => sum + calculateRowValues(item).frameArea,
    0
  );
          ...
          {items.length > 0 && (
            <tfoot className="bg-slate-100 font-bold text-slate-800 border-t-2 border-slate-300">
              <tr>
                ...
                <td className="px-6 py-3 text-center text-indigo-700">
                  {totalDoorCount} Adet
                </td>
                <td className="px-6 py-3 text-right text-indigo-700">
                  {totalLeafArea.toFixed(2)} m²
                </td>
                <td className="px-6 py-3 text-right text-indigo-700">
                  {totalFrameArea.toFixed(2)} m²
                </td>
                <td></td>
              </tr>
            </tfoot>
...
const WindowCalculationArea = ({ items, setItems, onUpdateQuantities }) => {
  ...
  const totalPVCCount = pvcWindows.reduce(
    (acc, i) => acc + (parseFloat(i.count) || 0),
    0
  );
  const totalAluCount = aluWindows.reduce(
    (acc, i) => acc + (parseFloat(i.count) || 0),
    0
  );

  const totalPVCWeight = pvcWindows.reduce(
    (acc, item) => acc + calculateWindowValues(item).weight,
    0
  );
  const totalAluWeight = aluWindows.reduce(
    (acc, item) => acc + calculateWindowValues(item).weight,
    0
  );

  const totalWindowCount = items.reduce(
    (sum, item) => sum + (parseFloat(item.count) || 0),
    0
  );
  ...
  // Toplam Cam Alanı
  const totalGlassArea = items.reduce(
    (sum, item) => sum + calculateWindowValues(item).glassArea,
    0
  );
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-10">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 relative overflow-hidden">
        ...
        <h3 className="text-sm font-bold text-slate-500 uppercase mb-4 tracking-wider flex items-center">
          ...
          {editingId
            ? 'Pencere Düzenle'
            : `Yeni ${windowType === 'pvc' ? 'PVC' : 'Alüminyum'} Pencere Ekle`}
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 items-end relative z-10">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setNewItem({ ...newItem, middleRegister: e.target.value })
              }
              className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
              placeholder="0"
            />
          ...
          <tbody className="divide-y divide-slate-100">
            {items.length === 0 ? (
              ...
              items.map((item) => {
                ...
                const posNo =
                  item.type === 'pvc' ? '15.455.1001' : '15.460.1010';
...
export default function App() {
  ...
  const [architecturalItems, setArchitecturalItems] = useState(
  ...
  useEffect(() => {
    ...
    if (savedData) {
      try {
        ...
        if (parsed.architecturalItems)
          setArchitecturalItems(parsed.architecturalItems);
  ...
  const handleExportToXLSX = () => {
    if (!isXLSXLoaded || !window.XLSX) {
      alert(
        'Excel modülü henüz yüklenmedi. Lütfen sayfayı yenileyip tekrar deneyin.'
      );
      return;
    }
    ...
    reader.onload = (evt) => {
      ...
      const validateSheet = (sheet) => {
        ...
        for (let C = range.s.c; C <= range.e.c; ++C) {
          const cell =
            sheet[window.XLSX.utils.encode_cell({ r: range.s.r, c: C })];
      ...
      if (!staticSheetName || !archSheetName) {
        alert(
          "Hata: Yüklenen Excel dosyası 'Statik Metraj' ve 'Mimari Metraj' sayfalarını içermelidir. Lütfen sistemden indirdiğiniz şablonu kullanın."
        );
        e.target.value = null;
        return;
      }
      ...
      if (staticSheetName) {
        const rawData = window.XLSX.utils.sheet_to_json(
          wb.Sheets[staticSheetName]
        );
      ...
      alert(
        'Veriler Excel (.xlsx) dosyasından başarıyla yüklendi ve güncellendi!'
      );
    };
    ...
    try {
      ...
      alert(
        `İşlem Tamamlandı!\nPDF tarandı ve ${updatedCount} adet pozun fiyatı güncellendi.\n${
          Object.keys(newPricesMap).length
        } adet poz tarifleriyle birlikte hafızaya alındı.`
      );
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-slate-100 font-sans text-slate-800 pb-20 relative">
              ...
              <>
                ...
                <div className="relative group hidden md:block">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 px-3 py-2 rounded-lg text-xs font-bold transition-all border bg-indigo-600 hover:bg-indigo-500 text-white border-indigo-500 shadow-lg shadow-indigo-900/20 active:scale-95"
                  >
                    <RefreshCw
                      className={`w-3 h-3 ${
                        isLoadingScripts ? 'animate-spin' : ''
                      }`}
                    />{' '}
                ...
                <div className="flex bg-slate-800 p-1 rounded-xl border border-slate-700 hidden md:flex">
                  <button
                    onClick={handleDownloadDescriptions}
      ...
      <main
        className={`max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-10 transition-all duration-500 ${
          !isLoggedIn
            ? 'blur-sm pointer-events-none select-none opacity-50 overflow-hidden h-screen'
            : ''
        }`}
      >
        ...
        <div className="flex flex-col space-y-0">
          ...
          <div className="bg-white rounded-b-2xl rounded-tr-2xl shadow-xl border border-slate-200 min-h-[500px] p-8 relative z-10">
            {activeTab === 'static' && (
              <>
                <GroupedTable
                  data={staticItems}
                  onUpdateQuantity={(id, val) =>
                    handleUpdateQuantity(id, val, 'static')
                  }
                ...
                <div className="mt-8 p-6 bg-slate-900 text-white rounded-xl shadow-lg flex justify-between items-center sticky bottom-4 z-20 border border-slate-700">
                  ...
                  <div className="text-right flex items-baseline">
                    <span className="text-slate-400 text-sm mr-4 font-bold uppercase tracking-wider">
                      Sayfa Toplamı:
                    </span>
            ...
            {activeTab === 'architectural' && (
              <>
                <GroupedTable
                  ...
                  onUpdateQuantity={(id, val) =>
                    handleUpdateQuantity(id, val, 'architectural')
                  }
                  onOpenSelector={handleOpenSelector}
                  onAddNewItem={handleAddNewItem}
                />
                <div className="mt-8 p-6 bg-slate-900 text-white rounded-xl shadow-lg flex justify-between items-center sticky bottom-4 z-20 border border-slate-700">
                  ...
                  <div className="text-right flex items-baseline">
                    ...
                    <span className="text-3xl font-black text-white tracking-tight">
                      {formatCurrency(architecturalTotal)}
                    </span>
                  </div>
                </div>
              </>
        ...
        <div className="fixed inset-0 z-10 flex items-center justify-center pointer-events-none">
          <div className="bg-slate-900/90 text-white p-8 rounded-2xl shadow-2xl flex flex-col items-center max-w-md text-center pointer-events-auto border border-slate-700">
            ...
            <p className="text-slate-400 mb-6">
              Verilere erişmek ve işlem yapmak için lütfen yetkili girişi
              yapınız.
            </p>
            <button
              onClick={() => setIsLoginModalOpen(true)}
